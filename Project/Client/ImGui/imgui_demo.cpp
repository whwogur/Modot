...
static void ShowDemoWindowWidgets(ImGuiDemoWindowData* demo_data)
{
    ...
    if (ImGui::TreeNode("Images"))
    {
        ...
        //   to ImGui::Image((ImTextureID)), and gather width/height through your own functions, etc.
        ...
        float my_tex_h = (float)io.Fonts->TexHeight;
        {
            ...
            ImGui::Image((ImTextureID)my_tex_id, ImVec2(my_tex_w, my_tex_h), uv_min, uv_max, tint_col, border_col);
            if (ImGui::BeginItemTooltip())
            {
                ...
                ImGui::Image((ImTextureID)my_tex_id, ImVec2(region_sz * zoom, region_sz * zoom), uv0, uv1, tint_col, border_col);
                ImGui::EndTooltip();
            }
        }
